...
| CI | [cinco jobs verdes no SHA `7970a79`](https://github.com/verticalpartnersai-sketch/haz-que-vuelva-lw-dr/actions/runs/30717658134), incluindo recuperação sintética fail-closed, `npm audit` nos três apps e `pip-audit` no agente Python |
